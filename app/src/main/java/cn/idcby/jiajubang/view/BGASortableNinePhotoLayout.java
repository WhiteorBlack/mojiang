...
//        setLayoutManager(mGridLayoutManager);
        mLineLayoutManager = new LinearLayoutManager(getContext());
        mLineLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
        setLayoutManager(mLineLayoutManager);
    ...
    private class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (actionState != ACTION_STATE_IDLE) {
                ...
                ((BGARecyclerViewHolder) viewHolder).getViewHolderHelper().getImageView(R.id.iv_item_nine_photo_photo).setColorFilter(getResources().getColor(cn.bingoogolapple.photopicker.R.color.bga_pp_photo_selected_mask));
            }
