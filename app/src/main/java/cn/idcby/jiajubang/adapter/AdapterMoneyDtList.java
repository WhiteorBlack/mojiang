...
public class AdapterMoneyDtList extends BaseAdapter {
    private Context context ;
    private List<MoneyDetailsList> mDataList ;

    public AdapterMoneyDtList(Context context, List<MoneyDetailsList> mDataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        MoneyDetailsList info = mDataList.get(i) ;
        if(info != null){
            ...
            holder.mMoneyTv.setTextColor(context.getResources().getColor(info.isAdd()
                    ? R.color.color_money_two : R.color.color_nomal_text));
        }
