...
import idcby.cn.imagepicker.container.GridViewForScrollView;
import idcby.cn.imagepicker.container.SimpleImageAdapter;
import idcby.cn.imagepicker.utils.FileUtils;
import idcby.cn.imagepicker.utils.Utils;

public class ImageConfig {
    private boolean isReloadModel = false ;//重选模式，即之前选的图片不计入重新选（也就是可重复选图）
    ...
    public static class Builder implements Serializable {
        private boolean isReloadModel = false ;
        ...
        public Builder isReloadModel(boolean reload){
            this.isReloadModel = reload ;
            return this ;
        }
