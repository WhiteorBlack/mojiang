...
public class AdapterNeedsList extends BaseAdapter {
    private Activity mContext ;
    private List<NeedsList> mDataList ;
    private int mOffset = 0 ;

    public AdapterNeedsList(Activity mContext, List<NeedsList> mDataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        NdHolder holder ;
        if(null == view){
            view = LayoutInflater.from(mContext).inflate(R.layout.adapter_needs_list , viewGroup , false) ;
    ...
    private static class NdHolder {
        ...
        public NdHolder(View view) {
            mTypeTv = view.findViewById(R.id.adapter_needs_list_type_tv) ;
            mTitleTv = view.findViewById(R.id.adapter_needs_list_title_tv) ;
            mTimeTv = view.findViewById(R.id.adapter_needs_list_endTime_tv) ;
            mContentTv = view.findViewById(R.id.adapter_needs_list_content_tv) ;
            mLocationTv = view.findViewById(R.id.adapter_needs_list_location_tv) ;
            mSupportTv = view.findViewById(R.id.adapter_needs_list_support_tv) ;
            mCommentTv = view.findViewById(R.id.adapter_needs_list_comment_tv) ;
            mPicLay = view.findViewById(R.id.adapter_needs_list_pic_lay) ;
