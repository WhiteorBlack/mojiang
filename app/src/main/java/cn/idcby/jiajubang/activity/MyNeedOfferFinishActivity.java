...
public class MyNeedOfferFinishActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutID() {
        return R.layout.activity_my_need_offer_finish ;
    }

    @Override
    public void initView() {
        mContentEv = findViewById(R.id.acti_my_need_offer_finish_content_ev) ;
        mImageRv = findViewById(R.id.acti_my_need_offer_finish_image_rv) ;
        TextView mSubmitTv = findViewById(R.id.acti_my_need_offer_finish_submit_tv) ;
...
//            mContentEv.setText("");
//            ToastUtils.showToast(mContext ,"请输入工作内容");
//            return ;
//        }
//
