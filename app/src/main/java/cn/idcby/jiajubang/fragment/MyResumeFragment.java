...
import cn.idcby.jiajubang.activity.CreateResumeActivity;
...
public class MyResumeFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        mAdapter = new AdapterMyResumeList(mContext ,false, mDataList,new RvItemViewClickListener() {
            @Override
            public void onItemClickListener(int type, final int position) {
                ...
                if(0 == type){
                    ...
                    refreshOptions(resumeList.getResumeId());
                }else if(3 == type){//上下架
                    updownOptions(resumeList.getResumeId());
    ...
    private void updownOptions(String optionId){
        ...
        NetUtils.getDataFromServerByPost(mContext, Urls.RESUME_UPDOWN, paramMap
    ...
    private void refreshOptions(String optionId){
        ...
        Map<String,String> paramMap = ParaUtils.getParaWithToken(mContext) ;
        paramMap.put("Code" ,optionId) ;
        NetUtils.getDataFromServerByPost(mContext, Urls.RESUME_REFRESH, paramMap
    ...
    private void getDataList(){
        ...
        NetUtils.getDataFromServerByPost(mContext, Urls.MY_RESUME_LIST, false, paramMap
