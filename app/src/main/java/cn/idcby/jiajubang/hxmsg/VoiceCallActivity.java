...
package cn.idcby.jiajubang.hxmsg;
...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		userIv = (ImageView) findViewById(R.id.swing_card);
...
//                                        callStateTextView.setText(st7);
    ...
    protected void onDestroy() {
	    NetUtils.cancelTag("getUserInfos" + username) ;
        ...
        NetUtils.getDataFromServerByPost(mContext, Urls.USER_HX_INFO, paramMap
                , new RequestObjectCallBack<UserInfo>("getUserInfos" + hxName ,mContext ,UserInfo.class) {
                    ...
                    public void onSuccessResult(UserInfo bean) {
                        if(bean != null){
                            nickTextView.setText(bean.getRealName()) ;
                            GlideUtils.loaderUser(bean.getHeadIcon() ,userIv) ;
                    ...
                    public void onErrorResult(String str) {
                        EaseUser user = MyApplication.getUserInfo(username) ;
                        if(user != null){
                            nickTextView.setText(StringUtils.convertNull(user.getNickname())) ;
                            GlideUtils.loaderUser(user.getAvatar() ,userIv) ;
                        }
                    }
                    @Override
