...
public class NearGoodListFragment extends BaseFragment implements View.OnClickListener {

    private boolean mIsSpec = false;//是否是专场
    private int mUnuseType = 2;//1最新 2 附近
...
//        mSearchKey = getIntent().getStringExtra(SkipUtils.INTENT_SEARCH_KEY) ;
        ...
        View rightIv = view.findViewById(R.id.acti_unuse_good_list_right_iv);
        View searchLay = view.findViewById(R.id.acti_unuse_good_list_search_lay);
        mSearchKeyTv = view.findViewById(R.id.acti_unuse_good_list_search_key_tv);
        mRefreshLay = view.findViewById(R.id.acti_unuse_good_list_refresh_lay);
        mLv = view.findViewById(R.id.acti_unuse_good_list_lv);
        mLoadingLay = view.findViewById(R.id.acti_unuse_good_list_loading_lay);
        mNullTv = view.findViewById(R.id.acti_unuse_good_list_null_tv);
        ...
        View mNavLay = view.findViewById(R.id.acti_unuse_good_list_nav_lay);
        View mNearlyLay = view.findViewById(R.id.acti_unuse_good_list_nav_nearly_lay);
        mNearlyTv = view.findViewById(R.id.acti_unuse_good_list_nav_nearly_tv);
        mNearlyDv = view.findViewById(R.id.acti_unuse_good_list_nav_nearly_dv);
        View mLatestLay = view.findViewById(R.id.acti_unuse_good_list_nav_latest_lay);
        mLatestTv = view.findViewById(R.id.acti_unuse_good_list_nav_latest_tv);
...
//        rightIv.setOnClickListener(this);
    ...
    protected int setSuccessViewId() {
        return R.layout.fragment_unuse_good_list;
    }
