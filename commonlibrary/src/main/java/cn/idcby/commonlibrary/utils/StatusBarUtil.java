...
public class StatusBarUtil {
    public static int DEFAULT_STATUS_BAR_COLOR = 0x99222222;
    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    public static final int DEFAULT_STATUS_BAR_ALPHA_TRANS = 0;
    ...
    /**
     * 设置statusBar的默认颜色，如果大于 API 21 ，就取系统的，否则就用自己设置的default
     * @param activity ac
     */
    public static void setDefaultStatusBarColor(Activity activity){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            DEFAULT_STATUS_BAR_COLOR = activity.getWindow().getStatusBarColor();
        }
    }
    ...
    public static void resetStatusBarColor(Activity activity){
        setColor(activity , DEFAULT_STATUS_BAR_COLOR) ;
    }
     ...
     * @param color    状态栏颜色值
     */
    public static void setColorAndTrans(Activity activity, @ColorInt int color) {
        setColor(activity, color, DEFAULT_STATUS_BAR_ALPHA_TRANS);
    }
