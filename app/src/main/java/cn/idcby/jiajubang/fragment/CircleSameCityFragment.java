...
public class CircleSameCityFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        mRefreshLay = view.findViewById(R.id.frag_same_city_circle_refresh_lay);
        mRecyclerView = view.findViewById(R.id.frag_same_city_circle_lv);
        ...
        mCategoryAdapter = new AdapterCircleCategory(mContext, mCategoryList, new RvItemViewClickListener() {
            ...
            public void onItemClickListener(int type, int position) {
                ...
                if(category != null){
                    ...
                    CircleListActivity.launch(mActivity ,1,categoryId,categoryName ,REQUEST_CODE_LIST);
                }
            }
        }) ;
     ...
     * 同城
     */
    private void getSameCityActive(){
        mIsLoading = true ;
        ...
        NetUtils.getDataFromServerByPost(mContext, Urls.SAME_CITY_POST_LIST, false, paramMap
                , new RequestListCallBack<UserActive>("getSameCityActive" , mContext ,UserActive.class) {
                    @Override
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(mIsReload && isVisibleToUser && mCategoryList != null && mCategoryList.size() == 0){
            getCategoryList() ;
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        }else if(REQUEST_CODE_LIST == requestCode){//从列表返回的，列表可能操作了，回来了是否刷新
