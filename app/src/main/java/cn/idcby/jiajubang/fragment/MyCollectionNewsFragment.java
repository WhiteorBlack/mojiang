...
public class MyCollectionNewsFragment extends BaseFragment {
    ...
    public static MyCollectionNewsFragment getInstance(int collectionType) {
       MyCollectionNewsFragment fragment = new MyCollectionNewsFragment() ;
    ...
    protected void initView(View view) {
        ...
        mAdapter = new HomeHotNewsAdapter(mContext, mList);
    ...
    private void getDataList(){
        ...
        NetUtils.getDataFromServerByPost(mContext, Urls.MY_COLLECTION_LIST_BY_TYPE, false, paramMap
                , new RequestListCallBack<NewsList>("getDataList" +  mCollectionType , mContext ,NewsList.class) {
                    @Override
