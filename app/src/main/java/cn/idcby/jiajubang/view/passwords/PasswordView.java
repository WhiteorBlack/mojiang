...
public class PasswordView extends RelativeLayout {
    ...
    private TextView tvMissPassWord;
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        tvMoney=(TextView)view.findViewById(R.id.textAmount);
        tvMessage=(TextView)view.findViewById(R.id.textShouxuFei);
        tvMissPassWord=(TextView)view.findViewById(R.id.tv_forgetPwd);
    ...
    public TextView getTvMoney(){return tvMoney;}
    public TextView getTvMessage(){return tvMessage;}
    public TextView getTvMissPassWord(){return tvMissPassWord;}
}
