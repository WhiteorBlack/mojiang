...
public class AdapterCircleComment extends BaseAdapter {
    private Activity context ;
    private List<CommentCircleList> mDataList ;
    private RvItemViewClickListener mClickListener ;

    public AdapterCircleComment(List<CommentCircleList> datas, Activity context ,RvItemViewClickListener mClickListener) {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        final CommentCircleList bean = mDataList.get(position);
        if(bean != null){
            ...
            List<CommentCircleList> replyList = bean.getChildList() ;
            if(replyList != null && replyList.size() > 0){
                holder.lvSecondComment.setVisibility(View.VISIBLE) ;
                AdapterCircleCommentReply replyAdapter = new AdapterCircleCommentReply(replyList , context) ;
