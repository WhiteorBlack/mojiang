...
//    private LinearLayout mCategoryIndLay ;
    ...
    private LinearLayout llTopClass,llHeaderTopClass;
    private RelativeLayout rlLatest, rlNearby;
...
//    private List<ImageView> mRecommendShopBottomImages = new ArrayList<>();
    ...
    public void dealOhterClick(View view) {
        ...
        } else if (R.id.header_unused_nav_latest_lay == i || R.id.unused_nav_latest_lay_top == i) {
            changeListByType(1);
        } else if (R.id.header_unused_nav_nearly_lay == i || R.id.unused_nav_nearly_lay_top == i) {
            changeListByType(2);
    ...
    private void initBaseView() {
        mContext = this;
        ((TextView) findViewById(R.id.tv_title)).setText("行业闲置");
        llTopClass = findViewById(R.id.unused_nav_lay);

        rlLatest = findViewById(R.id.unused_nav_latest_lay_top);
        rlLatest.setOnClickListener(this);
        rlNearby = findViewById(R.id.unused_nav_nearly_lay_top);
...
//        StatusBarUtil.setTransparentForImageView(this, null);
        ...
        //header
        headerView = LayoutInflater.from(mContext).inflate(R.layout.header_unused_item, null);
...
//        mCategoryIndLay = headerView.findViewById(R.id.header_unused_category_vp_indicator) ;
        ...
        llHeaderTopClass=headerView.findViewById(R.id. header_unused_nav_lay);
...
//        mTopBanner.setImageLoader(new BannerImageLoader()) ;
        ...
        mListView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                ViewUtil.setViewVisible(llTopClass, mScrollY > (headerView.getHeight()-llHeaderTopClass.getHeight()));
            }
        });
