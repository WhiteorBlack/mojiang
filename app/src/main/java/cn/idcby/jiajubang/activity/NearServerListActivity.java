...
public class NearServerListActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        TextView titleTv = findViewById(R.id.acti_near_server_list_title_tv) ;
        mRefreshLay = findViewById(R.id.acti_near_server_list_refresh_lay) ;
        mLv = findViewById(R.id.acti_near_server_list_lv);
        mLoadingLay = findViewById(R.id.acti_near_server_list_loading_lay) ;

        titleTv.setText(mIsInstallSer ? "附近安装" : "附近服务");
            ...
            public void onItemClickListener(int type, int position) {
                if(0 == type){
                    ...
                    if(serverList != null){
                        ...
                        ServerDetailActivity.launch(mContext ,userId,mIsInstallSer) ;
                    }
                }
            }
        }) ;
...
//        String url = mIsInstallSer ? Urls.API_NEAR_SERVER_INSTALL : Urls.API_NEAR_SERVER ;
        String url = mIsInstallSer ? Urls.API_NEAR_SERVER_INSTALL : Urls.SERVER_LIST_SERVER ;
