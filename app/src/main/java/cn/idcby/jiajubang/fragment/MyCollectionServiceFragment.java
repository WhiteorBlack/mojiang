...
import cn.idcby.jiajubang.adapter.AdapterCollectionService;
...
public class MyCollectionServiceFragment extends BaseFragment {
    ...
    private AdapterCollectionService mAdapter;
    private List<ServiceList> mList = new ArrayList<>() ;
    ...
    public static MyCollectionServiceFragment getInstance(int collectionType) {
       MyCollectionServiceFragment fragment = new MyCollectionServiceFragment() ;
    ...
    protected void initView(View view) {
        ...
        mAdapter = new AdapterCollectionService( mContext, mList);
    ...
    private void getDataList(){
        ...
        NetUtils.getDataFromServerByPost(mContext, Urls.MY_COLLECTION_LIST_BY_TYPE, false, paramMap
                , new RequestListCallBack<ServiceList>("getDataList" +  mCollectionType , mContext ,ServiceList.class) {
                    @Override
