    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                LogUtils.showLog("SmartPullAbleLayout>>>downX>>>" + downX);
                LogUtils.showLog("SmartPullAbleLayout>>>downY>>>" + downY);
                getY();
                break;
            }
...
//                LogUtils.showLog("SmartPullAbleLayout>>>moveX>>>" + moveX);
//                LogUtils.showLog("SmartPullAbleLayout>>>moveY>>>" + moveY);
