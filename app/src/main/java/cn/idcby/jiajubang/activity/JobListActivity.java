...
public class JobListActivity extends BaseActivity {
    ...
    private int mSiftWorkType = 0 ; // 0 全部 ，1 全职 2 兼职
    private static final int WORK_TYPE_NONE = 0 ;
    private static final int WORK_TYPE_ALL = 1 ;
    private static final int WORK_TYPE_HALF = 2 ;
    private int mSelectedWorkType = 0 ;
    ...
    public void initView() {
        ...
        View backIv = findViewById(R.id.acti_job_list_back) ;
    ...
    private void initSiftView(){
        View mNavLocationLay = findViewById(R.id.acti_job_list_nav_location_lay) ;
        mNavLocationIv = findViewById(R.id.acti_job_list_nav_location_iv) ;
        mNavLocationTv = findViewById(R.id.acti_job_list_nav_location_tv) ;
        View mNavPostLay = findViewById(R.id.acti_job_list_nav_post_lay) ;
        mNavPostIv = findViewById(R.id.acti_job_list_nav_post_iv) ;
        mNavPostTv = findViewById(R.id.acti_job_list_nav_post_tv) ;
        View mNavOtherLay = findViewById(R.id.acti_job_list_nav_other_lay) ;
        mNavOtherIv = findViewById(R.id.acti_job_list_nav_other_iv) ;
        mNavLocationLay.setOnClickListener(this);
        mNavPostLay.setOnClickListener(this);
        mNavOtherLay.setOnClickListener(this);

        mSiftParentLay = findViewById(R.id.acti_job_list_sift_lay) ;
        mSiftParentLay.setOnClickListener(this);

        mSiftLocationLay = findViewById(R.id.acti_job_list_sift_location_lay) ;
        RecyclerView mSiftLocationLeftRv = findViewById(R.id.acti_job_list_sift_location_left_rv) ;
        RecyclerView mSiftLocationRightRv = findViewById(R.id.acti_job_list_sift_location_right_rv) ;
        ...
        mSiftPostLay = findViewById(R.id.acti_job_list_sift_post_lay) ;
        RecyclerView mSiftPostLeftRv = findViewById(R.id.acti_job_list_sift_post_left_rv) ;
        RecyclerView mSiftPostRightRv = findViewById(R.id.acti_job_list_sift_post_right_rv) ;
        mSiftPostLay.setOnClickListener(this);

        mSiftOtherLay = findViewById(R.id.acti_job_list_sift_other_lay) ;
        GridView mSiftOtherEduLv = findViewById(R.id.acti_job_list_sift_other_edu_lv) ;
        GridView mSiftOtherExpLv = findViewById(R.id.acti_job_list_sift_other_exp_lv) ;
        mSiftOtherTypeAllTv = findViewById(R.id.acti_job_list_sift_other_work_type_all_tv) ;
        mSiftOtherTypeHalfTv = findViewById(R.id.acti_job_list_sift_other_work_type_half_tv) ;
        View mOtherOkLay = findViewById(R.id.acti_job_list_sift_other_ok_tv) ;
        View mOtherResetLay = findViewById(R.id.acti_job_list_sift_other_reset_tv) ;
...
//                ,getResources().getDrawable(R.drawable.activity_bg_drawable)));
    ...
    public void dealOhterClick(View view) {
        ...
        if(R.id.acti_job_list_right_iv == vId){
            ...
            JobListActivity.this.startActivityForResult(toShIt , 1003) ;
        }else if(R.id.acti_job_list_back == vId){
            onBackPressed() ;
        ...
        }else if(R.id.acti_job_list_nav_location_lay == vId){//筛选--位置
            changeSiftViewState(SIFT_STATE_LOCATION) ;
        }else if(R.id.acti_job_list_nav_post_lay == vId){//筛选--职位
            changeSiftViewState(SIFT_STATE_POST) ;
        }else if(R.id.acti_job_list_nav_other_lay == vId){//筛选--筛选
            changeSiftViewState(SIFT_STATE_OTHER) ;
        }else if(R.id.acti_job_list_sift_other_ok_tv == vId){//筛选--筛选--确定
            subOkSift() ;
        }else if(R.id.acti_job_list_sift_other_reset_tv == vId){//筛选--筛选--重置
            resetOtherSift() ;
        }else if(R.id.acti_job_list_sift_other_work_type_all_tv == vId){//筛选--筛选--全职
            changeWorkType(WORK_TYPE_ALL) ;
        }else if(R.id.acti_job_list_sift_other_work_type_half_tv == vId){//筛选--筛选--兼职
            changeWorkType(WORK_TYPE_HALF) ;
        }else if(R.id.acti_job_list_sift_lay == vId){//筛选--父布局--隐藏
            changeSiftViewState(mSiftState) ;
        }else if(R.id.acti_job_list_sift_location_lay == vId
                || R.id.acti_job_list_sift_post_lay == vId
                || R.id.acti_job_list_sift_other_lay == vId){//筛选--子布局--不操作
        }
    }
    ...
    private void subOkSift(){
        ...
        mSelectedWorkType = mSiftWorkType ;
        changeSiftViewState(SIFT_STATE_OTHER) ;
    ...
    private void resetOtherSift() {
        ...
        mEduCheckList.clear();
        mExpCheckList.clear();
        changeWorkType(WORK_TYPE_NONE) ;
        mSelectedWorkType = WORK_TYPE_NONE ;
    ...
    private void changeWorkType(int type){
        if(WORK_TYPE_NONE == mSiftWorkType){
            if(WORK_TYPE_ALL == type){
            ...
            if(WORK_TYPE_ALL == mSiftWorkType){
                ...
                if(WORK_TYPE_HALF == type){
                    mSiftOtherTypeHalfTv.setTextColor(mContext.getResources().getColor(R.color.color_good_param_theme));
                    mSiftOtherTypeHalfTv.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.bg_good_param_checked));

                    mSiftWorkType = type ;
                }else{
                    mSiftWorkType = WORK_TYPE_NONE ;
                }
            }else{
    ...
    private void resumeSiftOther(){
        ...
        if(mSelectedWorkType != mSiftWorkType){
            if(WORK_TYPE_ALL == mSiftWorkType){
                mSiftOtherTypeAllTv.setTextColor(mContext.getResources().getColor(R.color.color_nomal_text));
                mSiftOtherTypeAllTv.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.bg_good_param_nomal));

            }else if(WORK_TYPE_HALF == mSiftWorkType){
                mSiftOtherTypeHalfTv.setTextColor(mContext.getResources().getColor(R.color.color_nomal_text));
                mSiftOtherTypeHalfTv.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.bg_good_param_nomal));

            }
            mSiftWorkType = mSelectedWorkType ;
    ...
    private void intentToChooseResume(){
        if("".equals(SPUtils.newIntance(mContext).getToken())){
            SkipUtils.toLoginActivityForResult(JobListActivity.this , 1000) ;
        }else{
            Intent toCtIt = new Intent(mContext,ChooseResumeActivity.class) ;
            JobListActivity.this.startActivityForResult(toCtIt , 1001) ;
        }
    }
    ...
    private void getJobList(){
        ...
        paramMap.put("Type" , "2") ;//1 优质企业 2 全部
        ...
        paramMap.put("WorkType", "" + mSelectedWorkType) ;
    ...
    /**
     * 获取省份
     * @param isReset 是否是还原操作
     */
    private void getProvince(boolean isReset){
        if(mAllProvinceList.size() > 0){
            LogUtils.showLog("testJobAdapter","mCurProPosition=" + mCurProPosition + ",mCurCityPosition=" + mCurCityPosition);
