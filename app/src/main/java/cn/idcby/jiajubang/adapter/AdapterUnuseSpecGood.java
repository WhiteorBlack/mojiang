...
public class AdapterUnuseSpecGood extends RecyclerView.Adapter<AdapterUnuseSpecGood.UnsHolder> {
    private Activity context ;
    private List<UnuseGoodList> mDataList ;
    private RvItemViewClickListener mClickListener ;

    public AdapterUnuseSpecGood(Activity context, List<UnuseGoodList> mDataList, RvItemViewClickListener mClickListener) {
    ...
    @Override
    public UnsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new UnsHolder(LayoutInflater.from(context)
                .inflate(R.layout.adapter_unuse_spec_good_list ,parent ,false) ,mClickListener);
    }

    @Override
    public void onBindViewHolder(UnsHolder holder, int position) {
...
//            holder.mContentTv.setText(showContent);
    ...
    static class UnsHolder extends RecyclerView.ViewHolder{
        ...
        public UnsHolder(View itemView , final RvItemViewClickListener mClickListener ) {
            super(itemView);
