...
public class FlowLayout extends ViewGroup {
    ...
    private boolean singleLine = false; //单行显示，多的不显示
    private int maxChildCount = 0 ; //与singleLine搭配，判断最多显示多少个item
