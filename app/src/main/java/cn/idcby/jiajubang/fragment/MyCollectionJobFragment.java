...
public class MyCollectionJobFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        mRefreshLay = view.findViewById(R.id.frag_collection_job_refresh_lay);
        mRecyclerView = view.findViewById(R.id.frag_collection_job_rv);
     ...
     * 列表
     */
    private void getCollectionJobList(){
        mIsLoading = true ;
        ...
        NetUtils.getDataFromServerByPost(mContext, Urls.JOB_COLLECTION_LIST, false, paramMap
                , new RequestListCallBack<JobsCollectionList>("getCollectionJobList" , mContext ,JobsCollectionList.class) {
                    @Override
    ...
    public void onDestroy() {
        ...
        NetUtils.cancelTag("getCollectionJobList");
