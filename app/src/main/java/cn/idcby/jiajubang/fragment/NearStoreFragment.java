...
public class NearStoreFragment extends BaseFragment {
    ...
    public static void launch(Context context, boolean isSpec) {
        Intent toLiIt = new Intent(context, NearStoreFragment.class);
    ...
    protected void initView(View view) {
        ...
        materialRefreshLayout = view.findViewById(R.id.acti_near_store_refresh_lay);
        mRecycleView = view.findViewById(R.id.acti_near_store_rv);
        mNullTv = view.findViewById(R.id.acti_near_store_null_tv);
    ...
    protected int setSuccessViewId() {
        return R.layout.fragment_near_store_list;
    }
