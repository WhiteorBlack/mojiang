...
public class AdapterNeedsComment extends BaseAdapter {
    private Activity context ;
    private List<NeedsCommentList> mDataList ;
    private RvItemViewClickListener mClickListener ;


    public AdapterNeedsComment(List<NeedsCommentList> datas, Activity context ,RvItemViewClickListener mClickListener) {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        final NeedsCommentList bean = mDataList.get(position);
        if(bean != null){
            ...
            List<NeedsCommentList> replyList = bean.ChildList ;
            if(replyList != null && replyList.size() > 0){
                holder.lvSecondComment.setVisibility(View.VISIBLE) ;
                AdapterNeedsCommentReply replyAdapter = new AdapterNeedsCommentReply(replyList , context) ;
