...
public class DatePicker extends LinearLayout {
    ...
    public String[] getDate() {
        ...
        if (mViewMonth.getCurrentItem() + 1 < 10) {
            month = "0" + String.valueOf(mViewMonth.getCurrentItem() + 1);
        }
        String day = String.valueOf(mViewDay.getCurrentItem() + 1);
        if (mViewDay.getCurrentItem() + 1 < 10) {
            day = "0" + String.valueOf(mViewDay.getCurrentItem() + 1);
        }
