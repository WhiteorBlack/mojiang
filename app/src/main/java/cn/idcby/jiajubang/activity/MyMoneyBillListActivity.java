...
import cn.idcby.jiajubang.Bean.MoneyDetailsList;
import cn.idcby.jiajubang.R;
import cn.idcby.jiajubang.adapter.AdapterMoneyDtList;
...
public class MyMoneyBillListActivity extends BaseMoreStatusActivity {
    private MaterialRefreshLayout mRefreshLay ;
    private TextView mStartTimeTv ;
    private TextView mEndTimeTv ;

    private List<MoneyDetailsList> mDataList = new ArrayList<>() ;
    private AdapterMoneyDtList mAdapter ;
    ...
    public void init() {
        ...
        mAdapter = new AdapterMoneyDtList(mContext ,mDataList) ;
    ...
    private void getBillList(){
        ...
        NetUtils.getDataFromServerByPost(mContext, Urls.MY_MONEY_BILL_LIST, paramMap
                , new RequestListCallBack<MoneyDetailsList>("getBillList",mContext ,MoneyDetailsList.class) {
                    @Override
                    public void onSuccessResult(List<MoneyDetailsList> bean) {
                        showSuccessPage() ;
                        mDialog.dismiss() ;
