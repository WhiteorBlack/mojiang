...
//        StatusBarUtil.setTransparentForImageView(this, null);
        ((TextView) findViewById(R.id.tv_title)).setText("行业问答");
        ...
        //header
//        headerView = LayoutInflater.from(mContext).inflate(R.layout.header_question_item, null);

//        mTopBanner = headerView.findViewById(R.id.acti_question_banner_lay);
        View mSearchLay = findViewById(R.id.acti_question_search_lay);
        TextView mCreateNeedTv = findViewById(R.id.acti_question_create_question_tv);
        mHotUserRv = findViewById(R.id.acti_question_user_rv);
        mQuestionCateRv = findViewById(R.id.acti_question_category_rv);

        RadioGroup mTypeGroup = findViewById(R.id.acti_question_radio_lay);
