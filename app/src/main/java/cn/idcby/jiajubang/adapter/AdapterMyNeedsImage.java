...
public class AdapterMyNeedsImage extends
        RecyclerView.Adapter<AdapterMyNeedsImage.NewsListHeadLineHolderImage> {
    private Activity context ;
    private List<ImageThumb> mImageList ;
    private int mMoreImageWidHei ;
    private LayoutInflater inflater ;

    public AdapterMyNeedsImage(Activity context , List<ImageThumb> mImageList) {
        this.context = context ;
        this.mImageList = mImageList ;
        this.inflater = LayoutInflater.from(context) ;
        this.mMoreImageWidHei = (ResourceUtils.getScreenWidth(context)
                - ResourceUtils.dip2px(context , 15) * 2 - ResourceUtils.dip2px(context , 5) * 3) / 3 ;
    }
