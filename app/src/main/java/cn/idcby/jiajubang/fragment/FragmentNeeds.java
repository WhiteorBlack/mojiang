 ...
 */
@Deprecated
public class FragmentNeeds extends SpecBaseFragment {
    ...
    public static FragmentNeeds getInstance(int subsId){
        FragmentNeeds fs = new FragmentNeeds() ;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container
        ...
        if(null == mView){
            mView = inflater.inflate(R.layout.fragment_needs, container , false) ;

            mLv = mView.findViewById(R.id.fragment_needs_lv);
            mNullTv =  mView.findViewById(R.id.fragment_needs_loading_null_tv);
            mLoadingPb = mView.findViewById(R.id.fragment_needs_loading_null_pb);
